...
import {months, weekdays as weekdaysArr} from "@/utils/weekdays"
interface Props {
  selectedDate: Date;
...
const LessonInstanceDatePickerMobile = ({ selectedDate, setSelectedDate }: Props) => {
  ...
  return (
    <View className="py-2">
        <Text className="text-text text-md text-center pb-3">{`${months[selectedDate.getMonth()]} ${selectedDate.getFullYear()}`}</Text>
